...
const Data = () => {
  ...
  <div className="home__data">
    <h1 className="home__title">Pradeep Karki
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <p className="home__description">I'm fueled by my passion for creativity and my unwavering commitment to delivering high-quality work.</p>
